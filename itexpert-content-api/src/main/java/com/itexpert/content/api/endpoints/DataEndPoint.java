...
public class DataEndPoint {
    ...
    public Mono<ResponseEntity<Boolean>> deleteByKey(@Parameter(description = "The key of the Data object") @PathVariable String key) {
        return dataHandler.deleteByKey(key)
                .map(ResponseEntity::ok);
    }
}
